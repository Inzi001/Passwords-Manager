...
const showPassword = () => {
    ...
    <td>${maskPassword(element.password)} <img onclick="copyText('${element.password}')" src="copy.svg" alt="Copy Button" width="10" width="10" height="10">
        ...
        <td><button class="btn btn-delete" onclick="deletePassword('${element.website}')">Delete</button></td>
    </tr>`
        }
...
document.querySelector(".btn").addEventListener("click", (e) => {
    ...
    let passwords = localStorage.getItem("passwords"); // taking a data from storage which key is password
    if (passwords == null) {
        let json = []
